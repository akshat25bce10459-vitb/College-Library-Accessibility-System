...
git clone [https://github.com/your-username/college-library-system.git](https://github.com/your-username/college-library-system.git)
cd college-library-system


Ensure the File Exists:
Verify that the main application file, library_management.py, is present in the directory.
...
# Scenario 2: Librarian Update (Option 2)
...
Expected Result: Success message, status changes to NOT AVAILABLE, and the return date is set.
Screenshots
<img width="1143" height="755" alt="image" src="https://github.com/user-attachments/assets/222a1dfd-c2b5-412e-9810-3fb02bbc2874" />
